...
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(
        message,
" ᴀʙᴇ ɢᴀɴᴅᴜ😂😂... ᴘᴇʜᴄʜᴀɴᴀ ғᴀᴅᴇᴅ ᴘᴀᴘᴀ ʜᴜ ᴛᴜᴍʜᴀʀᴀ👻 ",
    )


@Client.on_message(
    filters.me & (filters.command(["Faded"], ".") | filters.regex("^alpha"))
)
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(message, "FADED")
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit(" ᴊᴏʀ sᴇ ʙᴏʟᴏ ғᴀᴅᴇᴅ ᴘᴀᴘᴀ ᴋɪ ᴊᴀɪ💘")
...
async def gahite(client: Client, message: Message):
    ...
    await message.edit("▪️▪️▪️▪️ \n▪️▪️▪️▪️ \n▪️▪️▪️▪️ \n▪️▪️▪️▪️ \n😵😵😵😵 \n")
    await asyncio.sleep(0.5)
    await message.edit("`RIP MAR GYA BSDK......`")
...
async def hajqag(client: Client, message: Message):
    ...
    await message.edit("Calling ㅤғᴀᴅᴇᴅ (ʙᴀᴀᴘ ᴏғ ᴛɢ)......")
    animation_chars = [
        "`Connecting To Telegram #_ғᴀᴅᴇᴅ`",
        "`Call Connected.`",
        "`ғᴀᴅᴇᴅ: Hello ʙᴏʟ ᴍᴄ. ᴋᴏɴ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ ʜᴀɪ ᴛᴜ...ʙsᴅᴋᴇ ᴋʏᴀ ᴋᴀᴀᴍ ʜᴀɪ ᴛᴇʀᴀ..?`",
        f"`Me:  ᴍᴇ ʜᴜɴ ᴛᴇʀᴀ` {DEFAULTUSER} ,`ᴍᴜᴛʜᴇ    ᴇᴋ ʀᴀɴᴅɪ ᴋɪ ɢᴀᴀɴᴅ🍃 ᴋɪ ɢᴀɴᴅ ᴍᴀʀɴɪ ʜᴀɪ..😁😁`",
        "`User Authorised.`",
        "`Calling ㅤ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃`  `At +916969696969`",
        "`Private  Call Connected...`",
        "`ʏᴏᴜ:ʜᴇʟʟᴏ ᴍᴄ, ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃...ᴛᴇʀɪ ᴍᴀ ᴋɪ ᴄʜᴜᴛ...🤣🤣😂.`",
        "ㅤ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #_ғᴀᴅᴇᴅ ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`ʏᴏᴜ: ᴀʙᴇ ᴢʜᴀᴛᴜ, ɪ ᴀᴍ` {DEFAULTUSER} ",
        "`ㅤ ғᴀᴅᴇᴅ 🍃 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴏᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`ʏᴏᴜ: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #_ғᴀᴅᴇᴅ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #ғᴀᴅᴇᴅ ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ...?😜.`",
        "`ㅤ ғᴀᴅᴇᴅ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_ғᴀᴅᴇᴅ ᴋᴇ ʜᴀᴠᴇʟɪ ᴘᴇ...🥵🥵.`",
        "`ʏᴏᴜ: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ ғᴀᴅᴇᴅ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\ᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_ғᴀᴅᴇᴅ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋᴇ ʟᴏᴠᴇ ᴜ ʙᴏʟɴᴇ  ᴋᴏ ʙᴏʟ😛😛.`",
        "`ʏᴏᴜ: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ ғᴀᴅᴇᴅ🍃 : ᴛᴏ #_ғᴀᴅᴇᴅ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #_ғᴀᴅᴇᴅ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀᴇ ʙᴀᴀᴘ ᴋɪ ᴄʜᴜᴛ ᴍᴀʀᴜɴɢᴀ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐 𝐅ᴀᴅᴇᴅ 𝐊ᴏ 𝐁ᴀᴀᴘ💞ᴋᴀʜɴᴀ ʜᴀɪ🤪 @CRY4DED_FR 👻 :)`",
        "`ᴘʀɪᴠᴀᴛᴇ ᴄᴀʟʟ ᴅɪsᴄᴏɴɴᴇᴄᴛᴇᴅ....ᴊᴏʀ sᴇ ʙᴏʟᴏ ғᴀᴅᴇᴅ ᴘᴀᴘᴀ ᴊɪ ᴊᴀɪ🤣🤣🤣`",
    ] 
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def gagahkah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "What The F",
        "What The F Brah",
        "[𝗪𝗵𝗮𝘁 𝗧𝗵𝗲 𝗙 𝗕𝗿𝗮𝗵](https://files.catbox.moe/h1xa2a.jpg)",
    ]
    for i in animation_ttl:
...
async def gajjajay(client: Client, message: Message):
    ...
    await asyncio.sleep(0.2)
    await message.edit("#_sᴀɴᴀᴛᴀɴɪ")
    await asyncio.sleep(0.3)
    await message.edit("ᴀʀɪᴠᴇ")
    await asyncio.sleep(0.3)
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("EVERyBOdy iZ GangSTur UNtIL #_ғᴀᴅᴇᴅ ᴀʀɪᴠᴇᴅ🔥🔥🔥")
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("ᴀʙᴇ sᴀʟᴇ ᴋʏᴀ ᴅᴇᴋʜ ʀᴀʜᴀ ᴛᴜ ʙʜɪ ᴛᴏʜ ᴋᴀʀᴛᴀ ʜ")
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12` ⚡𝐅𝐎𝐑 𝐑𝐄𝐌𝐎𝐕𝐄 𝐌𝐄𝐄𝐓 𝐌𝐘 🐉[ᴏᴡɴᴇʀ👻](https://t.me/CRY4DED_FR)"
    )
...
async def ngebundir(client: Client, message: Message):
    await edit_or_reply(
        message,
        "`ᴋᴜᴄʜ ɴᴀ ʙʀᴏ..ʙs #_ғᴀᴅᴇᴅ sᴇ ᴘᴀɴɢᴀ ʟɪʏᴀ...ɪsʟɪʏᴇ ʙᴀʀʙᴀᴅ ᴋᴀʀ ᴅɪʏᴀ ᴍᴜᴊʜᴇ ғᴀᴅᴇᴅ ʙᴀᴀᴘ ɴᴇ`          \n　　　　　|"
        "\n　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ɴɪᴋᴀʟ ᴍᴄ😥😥.. ɢᴀᴀʟɪ ɴᴀ ᴅᴇ ᴠᴀʀɴᴀ ғᴀᴅᴇᴅ ᴛᴇʀɪ ɢ**ᴅ ᴍᴀᴀʀ ʟᴇɢᴀ.👻`",
    )
