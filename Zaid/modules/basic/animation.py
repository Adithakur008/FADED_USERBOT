...
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(
        message,
" ᴀʙᴇ ɢᴀɴᴅᴜ😂😂... ᴘᴇʜᴄʜᴀɴᴀ sᴀɴᴀᴛᴀɴɪ ᴘᴀᴘᴀ ʜᴜ ᴛᴜᴍʜᴀʀᴀ👻 ",
    )


@Client.on_message(
    filters.me & (filters.command(["Sanatani"], ".") | filters.regex("^alpha"))
)
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(message, "sᴀɴᴀᴛᴀɴɪ")
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit(" ᴊᴏʀ sᴇ ʙᴏʟᴏ sᴀɴᴀᴛᴀɴɪ ᴘᴀᴘᴀ ᴋɪ ᴊᴀɪ💘")
...
async def hajqag(client: Client, message: Message):
    ...
    await message.edit("Calling ㅤsᴀɴᴀᴛᴀɴɪ (ʙᴀᴀᴘ ᴏғ ᴛɢ)......")
    animation_chars = [
        "`Connecting To Telegram #_sᴀɴᴀᴛᴀɴɪ`",
        "`Call Connected.`",
        "`sᴀɴᴀᴛᴀɴɪ: Hello ʙᴏʟ ᴍᴄ. ᴋᴏɴ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ ʜᴀɪ ᴛᴜ...ʙsᴅᴋᴇ ᴋʏᴀ ᴋᴀᴀᴍ ʜᴀɪ ᴛᴇʀᴀ..?`",
        ...
        "ㅤ ʀᴀɴᴅɪ ᴋᴀ ᴘɪʟʟᴀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #_sᴀɴᴀᴛᴀɴɪ ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`ᴍᴇ: ᴀʙᴇ ᴢʜᴀᴛᴜ, ɪ ᴀᴍ` {DEFAULTUSER} ",
        "`ㅤ sᴀɴᴀᴛᴀɴɪ 🍃 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴀᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`ᴍᴇ: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #_sᴀɴᴀᴛᴀɴɪ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #sᴀɴᴀᴛᴀɴɪ ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ...?😜.`",
        "`ㅤ sᴀɴᴀᴛᴀɴɪ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_sᴀɴᴀᴛᴀɴɪ ᴛᴇᴄʜ ᴋᴇ ʜᴀᴠᴇʟɪ ᴘᴇ...🥵🥵.`",
        "`ᴍᴇ: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ sᴀɴᴀᴛᴀɴɪ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_sᴀɴᴀᴛᴀɴɪ ᴛᴇᴄʜ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋᴇ ʟᴏᴠᴇ ᴜ ʙᴏʟɴᴇ  ᴋᴏ ʙᴏʟ😛😛.`",
        "`ᴍᴇ: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ sᴀɴᴀᴛᴀɴɪ🍃 : ᴛᴏ #_sᴀɴᴀᴛᴀɴɪ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #_sᴀɴᴀᴛᴀɴɪ ᴛᴇᴄʜ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀᴇ ʙᴀᴀᴘ ᴋɪ ᴄʜᴜᴛ ᴍᴀʀᴜɴɢᴀ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐 sᴀɴᴀᴛᴀɴɪ 𝐊ᴏ 𝐁ᴀᴀᴘ💞ᴋᴀʜɴᴀ ʜᴀɪ🤪 @ll_FADED_HU_ll 👻 :)`",
        "`ᴘʀɪᴠᴀᴛᴇ ᴄᴀʟʟ ᴅɪsᴄᴏɴɴᴇᴄᴛᴇᴅ....ᴊᴏʀ sᴇ ʙᴏʟᴏ sᴀɴᴀᴛᴀɴɪ ᴘᴀᴘᴀ ᴊɪ ᴊᴀɪ🤣🤣🤣`",
    ] 
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def gagahkah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "What The F",
        "What The F Brah",
        "[𝗪𝗵𝗮𝘁 𝗧𝗵𝗲 𝗙 𝗕𝗿𝗮𝗵](https://files.catbox.moe/id5nqm.jpg)",
    ]
    for i in animation_ttl:
...
async def gajjajay(client: Client, message: Message):
    ...
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("EVERyBOdy iZ GangSTur UNtIL #_sᴀɴᴀᴛᴀɴɪ ᴀʀɪᴠᴇᴅ🔥🔥🔥")
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12` 𝐅𝐎𝐑 𝐑𝐄𝐌𝐎𝐕𝐄 𝐌𝐄𝐄𝐓 𝐌𝐘 [ᴏᴡɴᴇʀ](https://t.me/ll_FADED_HU_ll)"
    )
...
async def ngebundir(client: Client, message: Message):
    await edit_or_reply(
        message,
        "`ᴋᴜᴄʜ ɴᴀ ʙʀᴏ..ʙs #_4sᴛ sᴇ ᴘᴀɴɢᴀ ʟɪʏᴀ...ɪsʟɪʏᴇ ʙᴀʀʙᴀᴅ ᴋᴀʀ ᴅɪʏᴀ ᴍᴜᴊʜᴇ sᴀɴᴀᴛᴀɴɪ ʙᴀᴀᴘ ɴᴇ`          \n　　　　　|"
        "\n　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
        "　　　　　| \n"
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ɴɪᴋᴀʟ ᴍᴄ😥😥.. ɢᴀᴀʟɪ ɴᴀ ᴅᴇ ᴠᴀʀɴᴀ sᴀɴᴀᴛᴀɴɪ ᴛᴇʀɪ ɢ**ᴅ ᴍᴀᴀʀ ʟᴇɢᴀ.👻`",
    )
